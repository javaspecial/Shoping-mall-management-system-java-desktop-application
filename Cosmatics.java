...
public class Cosmatics extends JFrame implements ActionListener {
    ...
    public Cosmatics() {
        ...
        labeln = new JLabel("Daily Cosmatics Request");
        ...
        txt1.setToolTipText("EnterCosmaticsRequestDate");
        jframe.add(txt1);
        ...
        model.addColumn("CTYPE");
        model.addColumn("CCATAGORY");
        model.addColumn("SNAME");

        jframe.setTitle("Daily Cosmatics Request");
        ...
        if (ae.getSource() == submit) {//list
            ...
            try {
                if (((txt1.getText()).equals(""))) {
                    ...
                    rs = statement.executeQuery("SELECT Cavailable,Cneed,Rdate,Ctype,Ccatagory,Sname from cosmaticsrequest where Rdate='" + txt1.getText() + "' ");
                    while (rs.next()) {
