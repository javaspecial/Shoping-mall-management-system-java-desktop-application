...
public class Electronics extends JFrame implements ActionListener {
    ...
    public Electronics() {
        ...
        labeln = new JLabel("Daily Electronics Request");
        ...
        txt1.setToolTipText("EnterElectronicsRequestDate");
        jframe.add(txt1);
        ...
        jframe.setTitle("Daily Electronics Request");
        ...
        if (ae.getSource() == submit) {//list
            ...
            try {
                if (((txt1.getText()).equals(""))) {
                    ...
                    rs = statement.executeQuery("SELECT Eavailable,Eneed,Edate,Etype,Ecatagory,Sname from electronicsrequest where Edate='" + txt1.getText() + "' ");
                    while (rs.next()) {
