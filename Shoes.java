...
public class Shoes extends JFrame implements ActionListener {
    ...
    public Shoes() {
        ...
        labeln = new JLabel("Daily Shoes Request");
        ...
        txt1.setToolTipText("EnterShoesRequestDate");
        jframe.add(txt1);
       ...
       model.addColumn("AVAILABLE");
        ...
        model.addColumn("STYPE");
        model.addColumn("SCATAGORY");
        model.addColumn("SNAME");
        jframe.setTitle("Daily Shoes Request");
        ...
        if (ae.getSource() == submit) {//list
            ...
            try {
                if (((txt1.getText()).equals(""))) {
                    ...
                    rs = statement.executeQuery("SELECT Savailable,Sneed,Rdate,Stype,Scatagory,Sname from shoesrequest where Rdate='" + txt1.getText() + "' ");
                    while (rs.next()) {
