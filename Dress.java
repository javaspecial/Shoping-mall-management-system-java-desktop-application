...
public class Dress extends JFrame implements ActionListener {
    ...
    public Dress() {
        ...
        labeln = new JLabel("Daily Dress Request");
        ...
        txt1.setToolTipText("EnterDressRequestDate");
        jframe.add(txt1);
        ...
        model.addColumn("DTYPE");
        model.addColumn("DCATAGORY");
        model.addColumn("SNAME");

        jframe.setTitle("Daily Dress Request");
        ...
        if (ae.getSource() == submit) {//list
            ...
            try {
                if (((txt1.getText()).equals(""))) {
                    ...
                    rs = statement.executeQuery("SELECT Davailable,Dneed,Rdate,Dtype,Dcatagory,Sname from dressrequest where Rdate='" + txt1.getText() + "' ");
                    while (rs.next()) {
